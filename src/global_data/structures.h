...
// typedef block_verifiers_list_t previous_block_verifiers_list;
// typedef block_verifiers_list_t current_block_verifiers_list;
// typedef block_verifiers_list_t next_block_verifiers_list;
